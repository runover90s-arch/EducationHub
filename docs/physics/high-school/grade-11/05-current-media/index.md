---
title: "Chương 5 — Dòng điện trong các môi trường"
description: "Mở rộng Vật lí 11: dòng điện trong kim loại, chất điện phân, chất khí, bán dẫn và chân không."
order: 5
...
```mermaid
graph TD
A[Dòng điện] --> B[Kim loại]
A --> C[Chất điện phân]
A --> D[Chất khí]
A --> E[Bán dẫn]
A --> F[Chân không]
B --> B1[Electron dẫn]
C --> C1[Ion dương và ion âm]
D --> D1[Electron và ion do ion hóa]
E --> E1[Electron và lỗ trống]
F --> F1[Electron phát từ catot]
```

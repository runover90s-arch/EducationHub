---
title: "Chương 7 — Cảm ứng điện từ"
description: "Từ thông, định luật Faraday–Lenz, suất điện động cảm ứng, thanh chuyển động và tự cảm."
order: 7
...
```mermaid
graph TD
A[Từ trường B] --> B[Từ thông Phi]
B --> C[Phi biến thiên]
C --> D[Suất điện động cảm ứng]
D --> E[Dòng điện cảm ứng]
E --> F[Từ trường cảm ứng]
F --> G[Định luật Lenz]
D --> H[Thanh dẫn chuyển động]
E --> I[Tự cảm]

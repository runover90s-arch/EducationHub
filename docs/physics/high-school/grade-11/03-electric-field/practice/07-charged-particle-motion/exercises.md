---
title: "Bài tập — Bài 7 — Chuyển động của điện tích trong điện trường đều"
...
??? success "Đáp án và lời giải"
    a) **Đúng.** Trong điện trường đều, $\vec F=q\vec E$; nếu $q$ và $\vec E$ không đổi thì lực điện không đổi.
...
??? success "Đáp án và lời giải"
    a) **Đúng.** Định lí động năng cho $\Delta K=qU$ theo dấu quy ước; với electron, độ lớn năng lượng nhận được qua hiệu điện thế $U$ là $eU$.

    b) **Đúng.** trong miền vận tốc không tương đối tính.

    c) **Sai.** Vì $\tfrac12mv^2=eU$ nên $v\propto\sqrt U$; tăng $U$ bốn lần chỉ làm $v$ tăng hai lần.
...
Hạt có $q=2\,\mu\,\mathrm C$, $m=4\cdot10^{-6}\,\mathrm{kg}$ trong điện trường $E=3000\,\mathrm{V/m}$. Tính gia tốc.

??? success "Đáp án và lời giải"
    $a=qE/m=2\cdot10^{-6}\cdot3000/(4\cdot10^{-6})=1500\,\mathrm{m/s^2}$, cùng chiều E vì q dương.

### Bài 8 — Mức 3 — Vận dụng

Electron được tăng tốc từ nghỉ qua hiệu điện thế $100\,\mathrm V$. Lấy $e=1,6\cdot10^{-19}\,\mathrm C$, $m_e=9,1\cdot10^{-31}\,\mathrm{kg}$. Tính tốc độ theo cơ học cổ điển.

??? success "Đáp án và lời giải"
    $\frac12m_ev^2=eU$. $v=\sqrt{2eU/m_e}=\sqrt{2\cdot1,6\cdot10^{-19}\cdot100/(9,1\cdot10^{-31})}\approx5,93\cdot10^6\,\mathrm{m/s}$.

### Bài 9 — Mức 3 — Vận dụng

Điện tích dương đi vào điện trường đều $E=2\cdot10^4\,\mathrm{V/m}$ với vận tốc đầu $v_0=10^5\,\mathrm{m/s}$ vuông góc E. Biết $q/m=10^7\,\mathrm{C/kg}$, chiều dài vùng điện trường theo phương v0 là $5\,\mathrm{cm}$. Tính thời gian ở trong trường.

??? success "Đáp án và lời giải"
    Chuyển động theo phương $v_0$ là đều: $t=L/v_0=0,05/10^5=5\cdot10^{-7}\,\mathrm s$.
...
??? success "Đáp án và lời giải"
    Gia tốc theo E: $a=(q/m)E=10^7\cdot2\cdot10^4=2\cdot10^{11}\,\mathrm{m/s^2}$.

    Thời gian $t=5\cdot10^{-7}\,\mathrm s$.

    Độ lệch:

    $y=\frac12at^2=0,5\cdot2\cdot10^{11}(5\cdot10^{-7})^2=0,025\,\mathrm m$ $=2,5\,\mathrm{cm}$.

    Thành phần vận tốc theo E khi ra: $v_y=at=2\cdot10^{11}\cdot5\cdot10^{-7}=10^5\,\mathrm{m/s}$.

    Thành phần dọc ban đầu vẫn $v_x=10^5\,\mathrm{m/s}$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    <!-- source-audit: Câu dẫn PDF in m_e=9,1e-19 kg; chính phép tính của nguồn dùng 9,1e-31 kg. Repo giữ 9,1e-31 kg. -->

#### Bài 13

<!-- source-id: BT-Chuong-III-p80-q8-206 -->

Hai bản kim loại có kích thước lớn và bằng nhau, đặt song song, cách nhau $d=24\,\mathrm{cm}$ như hình. Hiệu điện thế giữa hai bản là $48\,\mathrm V$. Một electron $(q=-1{,}6\cdot10^{-19}\,\mathrm C,\ m=9{,}1\cdot10^{-31}\,\mathrm{kg})$ bay vào chính giữa hai bản theo phương vuông góc với đường sức điện với vận tốc $200\,\mathrm{m/s}$. Bỏ qua điện trường của Trái Đất, lực cản môi trường và trọng lực tác dụng lên electron. Tìm tầm xa theo phương $Ox$ theo đơn vị micromet; làm tròn đến hàng phần mười.
...
Một electron di chuyển không vận tốc đầu được một đoạn $1\,\mathrm{cm}$ dọc theo một đường sức điện,
dưới tác dụng của lực điện trong một điện trường đều có cường độ $1\,000\,\mathrm{V/m}$. Hãy xác định công của lực
điện theo đơn vị $10^{-18}\,\mathrm J$ (Làm tròn kết quả đến hàng phần mười).
...
Xét điện trường đều tạo bởi hai bản kim loại đặt song song, cách nhau $2\,\mathrm{cm}$ có cường độ điện
trường bằng $5\cdot10^{3}\,\mathrm{V/m}$. Một hạt bụi mịn có điện tích $q=3\cdot10^{-19}\,\mathrm C$ lọt vào chính giữa khoảng điện trường
đều giữa hai bản kim loại. Coi tốc độ hạt bụi khi bắt đầu vào điện trường đều bằng 0, bỏ qua lực cản của
môi trường. Động năng của hạt bụi khi va chạm với bản nhiễm điện âm là bao nhiêu $10^{-17}\,\mathrm J$? Chọn mốc thế
...
Một ion âm OH− có khối lượng $2{,}833\cdot10^{-26}\,\mathrm{kg}$ được thổi ra từ máy lọc không
khí với vận tốc $10\,\mathrm{m/s}$ cách mặt đất $80\,\mathrm{cm}$ ở nơi có điện trường của Trái Đất bằng 120
V/m. Dưới tác dụng của lực điện, sau một thời gian, ion đang chuyển động với vận tốc
$0,5\,\mathrm{m/s}$ ở vị trí cách mặt đất $1,5\,\mathrm m$. Hãy xác định công cản mà môi trường đã thực hiện
trong quá trình dịch chuyển của ion nói trên theo đơn vị $10^{-17}\,\mathrm J$ (làm tròn kết quả đến
hàng phần mười).
...
Xét điện trường đều tạo bởi hai bản kim loại đặt song song, cách nhau $4\,\mathrm{cm}$ có cường độ điện trường
bằng $5\cdot10^{4}\,\mathrm{V/m}$. Một hạt bụi mịn có điện tích $q=3\cdot10^{-19}\,\mathrm C$ lọt vào chính giữa khoảng điện trường đều
giữa hai bản kim loại. Coi tốc độ hạt bụi khi bắt đầu vào điện trường đều bằng 0, bỏ qua lực cản của môi
trường. Động năng của hạt bụi khi va chạm với bản nhiễm điện âm là bao nhiêu $10^{-16}\,\mathrm J$? Chọn mốc thế
...
Cho, điện tích và khối lượng của electron lần lượt là $-1{,}6\cdot10^{-19}\,\mathrm C$; $9{,}1\cdot10^{-31}\,\mathrm{kg}$. Chọn mốc thế năng tại
mặt đất.
...
??? success "Đáp án và lời giải"
    ...
    **Chiến lược.** Dùng bảo toàn cơ năng giữa A và B; chọn trục độ cao hướng lên. Điện trường Trái Đất hướng xuống nên với độ lớn $E$, điện thế tăng theo độ cao và thế năng điện của electron là $W=qEd$.
    ...
    **Dấu và dữ kiện.** Electron có $q=-1{,}6\cdot10^{-19}\,\mathrm C$. Từ đồ thị: $v_A=2\cdot10^6\,\mathrm{m/s}$, $v_B=0$, $d_A=3{,}0\,\mathrm m$, $d_B=2{,}9\,\mathrm m$.

    **Nghiệm.**
    $E=\dfrac{9{,}1\cdot10^{-31}[0-(2\cdot10^6)^2]}{2(-1{,}6\cdot10^{-19})(3{,}0-2{,}9)}\approx113{,}75\,\mathrm{V/m}\approx114\,\mathrm{V/m}$.

    **Kiểm tra.** $E>0$ là độ lớn; electron đang đi xuống nhưng lực điện hướng lên, nên tốc độ giảm về $0$ tại B, phù hợp đồ thị.

#### Bài 21

<!-- source-id: BT-Chuong-III-p139-q5-343 -->

Một hạt bụi khối lượng $3{,}6\cdot10^{-15}\,\mathrm{kg}$ mang điện tích $q=6\cdot10^{-18}\,\mathrm C$ nằm lơ lửng giữa hai tấm kim loại
phẳng song song nằm ngang cách nhau $2\,\mathrm{cm}$ và nhiễm điện trái dấu. Lấy g = $10\,\mathrm{m/s^2}$. Hiệu điện thế giữa hai
...
Một prôtôn mang điện tích + $1{,}6\cdot10^{-19}\,\mathrm C$ chuyển động dọc theo phương của đường sức một điện trường
đều. Khi nó đi được quãng đường $5\,\mathrm{cm}$ thì lực điện thực hiện một công là + $1{,}6\cdot10^{-21}\,\mathrm J$. Tính cường độ điện
trường đều này.
...
hình thì người ta thu nhận được vận tốc của nó là $133\cdot10^{6}\,\mathrm{m/s}$. Bỏ qua vận tốc ban đầu của nó, hiệu điện thế
...
??? success "Đáp án và lời giải"
    ...
    **Chiến lược.** Tính $E$ từ hiệu điện thế và khoảng cách, rồi dùng $\vec a=q\vec E/m_e$.

    **Phương trình.**
    $E=U/d=100/0{,}10=1000\,\mathrm{V/m}$,
    $a=qE/m_e$.

    **Dấu và vectơ.** Chọn chiều dương cùng chiều $\vec E$. Electron có $q<0$ nên $\vec a$ ngược chiều $\vec E$; do đó $a<0$.

    **Nghiệm.**
    $a=\dfrac{-1{,}6\times10^{-19}\cdot1000}{9{,}1\times10^{-31}}\approx-1{,}76\times10^{14}\,\mathrm{m/s^2}$.
    Vậy chọn **A**.

    **Kiểm tra.** Electron đang chuyển động cùng chiều đường sức về bản âm nhưng gia tốc ngược chiều chuyển động, nên nó bị chậm dần; dấu âm của $a$ là phù hợp.

    <!-- source-audit: PDF in phương án A với bậc 1e13 và phép giải lấy E=100 V/m. Từ U/d=1000 V/m suy ra a=-1,76e14 m/s^2; phương án A được sửa tối thiểu bậc mười. -->
...
m/s. Cho cường độ điện trường đều có độ lớn $E=3000\,\mathrm{V/m}$, e = $1{,}6\cdot10^{-19}\,\mathrm C$, $m_p=1{,}67\cdot10^{-27}\,\mathrm{kg}$. Bỏ qua
tác dụng của trọng lực lên prôtôn. Sau khi đi được đoạn đường $3\,\mathrm{cm}$, tốc độ của prôtôn là

A. $3{,}98\cdot10^{5}\,\mathrm{m/s}$.

B. $5{,}64\cdot10^{5}\,\mathrm{m/s}$.

C. $3{,}78\cdot10^{5}\,\mathrm{m/s}$.

D. $4{,}21\cdot10^{5}\,\mathrm{m/s}$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Điện trường đều là điện trường có vectơ cường độ điện trường không đổi tại mọi điểm, tức không đổi cả độ lớn lẫn hướng. Vì vậy chọn **B**.
#### Bài 32
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Với điện tích âm, $\vec F=q\vec E$ ngược chiều $\vec E$. Vật được thả từ nghỉ nên gia tốc và chuyển động ban đầu theo chiều lực điện, tức ngược chiều đường sức. Chọn **B**.
#### Bài 33
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    $v_x=v_0$, $v_y=\dfrac{|q|E}{m}t$.

    Do đó
    $\tan\alpha=\dfrac{v_y}{v_x}=\dfrac{|q|E}{mv_0}t$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Trong điện trường tĩnh, lực điện là lực thế. Công khi điện tích đi từ M đến N là $A_{MN}=q(V_M-V_N)$, chỉ phụ thuộc hai điểm đầu - cuối, không phụ thuộc cung đường dịch chuyển. Chọn **A**.
#### Bài 39
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Đi hết một đường cong kín thì điểm cuối trùng điểm đầu, nên $\Delta V=0$. Vì $A=q(V_\text{đầu}-V_\text{cuối})$, công của lực điện bằng $0$ với mọi $q$. Chọn **D**.
#### Bài 40
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Trong điện trường đều, $A=qE\,\Delta x$ với $\Delta x$ là hình chiếu đại số của độ dời theo chiều $\vec E$. Trên hình, M, N, P có cùng hoành độ còn Q nằm bên phải: do đó $A_{MQ}=-A_{QN}$, $A_{MN}=A_{NP}=0$ và $A_{QP}=A_{QN}$. Trong khi $A_{MQ}\ne A_{MP}$ vì $A_{MP}=0$. Vậy phát biểu sai là **D**.
#### Bài 41
...
Một electron di chuyển không vận tốc đầu được một đoạn $1\,\mathrm{cm}$ dọc theo một đường sức điện, dưới
tác dụng của một lực điện trong một điện trường đều có cường độ $1\,000\,\mathrm{V/m}$. Công của lực điện khi đó
bằng

A. $1{,}6\cdot10^{-18}\,\mathrm J$.

B. $-1{,}6\cdot10^{-18}\,\mathrm J$.

C. $-1{,}6\cdot10^{-16}\,\mathrm J$.

D. $1{,}6\cdot10^{-16}\,\mathrm J$.
...
$2{,}5\cdot10^{4}\,\mathrm{m/s}$, khi đến điểm B tốc độ của nó bằng không. Biết hạt có khối lượng $2{,}672\cdot10^{-26}\,\mathrm{kg}$. Thế năng
điện tại A bằng $-8\cdot10^{-17}\,\mathrm J$. Thế năng điện tại B bằng

A. − $8{,}5\cdot10^{-17}\,\mathrm J$.

B. − $7{,}2\cdot10^{-17}\,\mathrm J$.

C. $7{,}2\cdot10^{-17}\,\mathrm J$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    <!-- source-audit: PDF gọi hạt là electron nhưng cho m=2,672e-26 kg; repo giữ dữ kiện khối lượng và dùng mô tả “điện tích âm”. -->
#### Bài 46
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Proton mang điện dương và tăng tốc dọc theo $\vec E$, nên công lực điện bằng độ tăng động năng:
    $qEd=\dfrac12mv^2$.
    Suy ra
    $d=\dfrac{mv^2}{2qE}=\dfrac{1{,}67\times10^{-27}(3\times10^4)^2}{2\cdot1{,}6\times10^{-19}\cdot200}\approx2{,}35\times10^{-2}\,\mathrm m=23{,}5\,\mathrm{mm}$.
    Chọn **B**.
#### Bài 47
...
A. $-3{,}04\cdot10^{-17}\,\mathrm J$.

B. $-1{,}264\cdot10^{-16}\,\mathrm J$.

C. $-1{,}76\cdot10^{-16}\,\mathrm J$.

D. $-4\cdot10^{-17}\,\mathrm J$.
...
Hai bản kim loại tích điện trái dấu, đặt song song và cách nhau $3\,\mathrm{cm}$. Độ lớn cường độ điện trường
...
A. $3{,}2\cdot10^{6}\,\mathrm{m/s}$.

B. $3{,}2\cdot10^{6}\,\mathrm{cm/s}$.

C. $1{,}6\cdot10^{6}\,\mathrm{m/s}$.

D. $1{,}6\cdot10^{6}\,\mathrm{cm/s}$.
...
Hai tấm kim loại phẳng nằm ngang song song cách nhau $5\,\mathrm{cm}$. Hiệu điện thế giữa hai tấm là $100\,\mathrm V$.
...
A. $5{,}93\cdot10^{6}\,\mathrm{m/s}$.

B. $3{,}52\cdot10^{6}\,\mathrm{m/s}$.

C. $4{,}19\cdot10^{6}\,\mathrm{m/s}$.

D. $6{,}85\cdot10^{6}\,\mathrm{m/s}$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Điện trường tĩnh dù không đều vẫn là trường thế. Với một quỹ đạo kín, $V_\text{cuối}=V_\text{đầu}$ nên $A=q(V_\text{đầu}-V_\text{cuối})=0$. Chọn **D**.
#### Bài 53
...
Hai tấm kim loại phẳng nằm ngang song song cách nhau $10\,\mathrm{cm}$. Hiệu điện thế giữa hai tấm là $150\,\mathrm V$.
Một electron không vận tốc ban đầu chuyển động từ tấm tích điện âm về tấm tích điện dương, biết khối lượng
của electron là $m_e=9{,}1\cdot10^{-31}\,\mathrm{kg}$. Khi đến tấm tích điện dương thì electron có vận tốc là
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    c) **Sai.** Electron mang điện âm nên gia tốc ngược chiều $\vec E$, có độ lớn $a=eE/m_e\approx1{,}05\times10^{14}\ \text{m/s}^2$. Thời gian trong vùng điện trường $t=l/v_x=0{,}08/(7\times10^6)\approx1{,}14\times10^{-8}\,\mathrm s$, nên $|v_y|\approx1{,}20\times10^6\ \text{m/s}$ và tốc độ khi ra khỏi bản khoảng $7{,}10\times10^6\ \text{m/s}$, không phải giá trị phát biểu.
    ...
    <!-- source-audit: Bảng đáp án/số mũ trong PDF không nhất quán; kết quả repo được kiểm độc lập từ E=U/d, a=eE/m_e và chuyển động trong điện trường đều. -->
#### Bài 56
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Đúng.** Điện trường hướng từ mặt đất tích điện dương lên đám mây tích điện âm.

    b) **Đúng.** $U=Q/C=40/(5\times10^{-10})=8\times10^{10}\,\mathrm V$.

    c) **Sai.** $E=U/d=8\times10^{10}/1600=5\times10^7\,\mathrm{V/m}$, lớn hơn giá trị phát biểu 10 lần.

    d) **Đúng.** Hình chiếu của $\overrightarrow{AB}$ lên phương thẳng đứng có độ lớn $1600\,\mathrm m$. Vì $q_0<0$ và độ dời từ A xuống B ngược chiều $\vec E$, công là $A=q_0E(-1600)=0{,}16\,\mathrm J$.
#### Bài 57
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Sai.** Đường sức điện giữa hai bản tích điện trái dấu hướng từ bản dương sang bản âm, không phải từ bản âm sang bản dương.

    b) **Đúng.** $E=U/d=25/(5\times10^{-3})=5000\,\mathrm{V/m}$.

    c) **Sai.** Electron xuất phát từ nghỉ và đi qua hiệu điện thế $25\,\mathrm V$, nên $\tfrac12m_ev^2=eU$. Suy ra $v\approx2{,}96\times10^6\,\mathrm{m/s}$, không phải $1{,}6\times10^6\,\mathrm{m/s}$.

    d) **Sai.** Electron chuyển động dọc theo đường sức nên gia tốc cùng một phương cố định với chuyển động; quỹ đạo là đoạn thẳng.

    <!-- source-audit: Bảng PDF đánh a) Đúng nhưng phần giải của nguồn nêu đường sức từ bản dương sang bản âm; repo giữ a) Sai. -->
#### Bài 58
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Sai.** Bỏ qua hiệu ứng mép, đường sức giữa hai bản tụ phẳng là các đường thẳng song song, cách đều, hướng từ bản dương sang bản âm.

    b) **Đúng.** $E=U/d=12/0{,}01=1200\,\mathrm{V/m}$.

    c) **Đúng.** Thành phần vận tốc theo phương song song hai bản không đổi, còn theo phương điện trường electron có gia tốc không đổi; loại $t$ từ $x=v_0t$ và $y=at^2/2$ cho phương trình bậc hai $y\propto x^2$, nên quỹ đạo là parabol.
    ...
    <!-- source-audit: Phần giải PDF mô tả quỹ đạo parabol nhưng bảng đáp án đánh c) Sai; repo giữ c) Đúng theo phương trình chuyển động. -->
#### Bài 59
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    c) **Sai.** Tam giác đều cạnh $4\,\mathrm{cm}$ có độ cao $HC=2\sqrt3\,\mathrm{cm}$. Từ $A$ đến $C$, hình chiếu độ dời lên phương điện trường ngược chiều $\vec E$, nên $A_{AC}=-qE\,HC=-3{,}2\sqrt3\times10^{-18}\,\mathrm J$.

    d) **Sai.** Từ $C$ đến $B$, hình chiếu độ dời cùng chiều $\vec E$, nên $A_{CB}=+3{,}2\sqrt3\times10^{-18}\,\mathrm J$. Hai công này trái dấu và có tổng bằng $0$.
#### Bài 60
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Electron đi từ bản âm đến bản dương. Chọn chiều $\vec E$ từ bản dương sang bản âm thì độ dời đại số của electron là $d=-a$ và $q_e<0$, nên $A=q_eEd>0$.

    a) **Sai.** Công của lực điện là dương.

    b) **Đúng.** Từ $\tfrac12m_ev^2=A=q_eEd$ suy ra $v=\sqrt{2q_eEd/m_e}$; tích $q_ed$ dương vì cả hai cùng âm.

    c) **Sai.** $A=-\Delta W_t>0$ nên thế năng điện giảm, không tăng.

    d) **Đúng.** Lực điện thực hiện công dương và thế năng điện giảm.
#### Bài 62

<!-- source-id: BT-Chuong-III-p118-q4-296 -->

Một điện tích điểm $q=+10\,\mu\mathrm C$ chuyển động trong điện trường đều có cường độ $5\,000\,\mathrm{V/m}$. Xét
tam giác đều MNP nằm trong điện trường đều, các đường sức song song với cạnh NP, có chiều từ N đến
P. Biết mỗi cạnh của tam giác MNP bằng $5\,\mathrm{cm}$.

a) Gọi H là chân đường vuông góc kẻ từ M đến NP. Khi đó, NH = HP = $2,5\,\mathrm{cm}$.

b) Công của lực điện làm điện tích q di chuyển từ M đến H xấp xỉ $0,002\,\mathrm J$.

c) Công của lực điện làm điện tích q di chuyển theo đường gấp khúc MPH xấp xỉ $0,02\,\mathrm J$.

d) Công của lực điện làm điện tích q di chuyển từ M đến N bằng − $0,00125\,\mathrm J$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Đúng.** Trong tam giác đều, đường cao MH đồng thời là trung tuyến nên $NH=HP=2{,}5\,\mathrm{cm}$.

    b) **Sai.** $MH\perp\vec E$ nên hình chiếu độ dời lên phương điện trường bằng $0$, do đó $A_{MH}=0$.

    c) **Sai.** Công lực điện chỉ phụ thuộc hai điểm đầu - cuối; đường M-P-H cũng đi từ M đến H nên $A_{MPH}=A_{MH}=0$.

    d) **Đúng.** Hình chiếu từ M đến N theo chiều $\vec E$ là $-0{,}025\,\mathrm m$: $A_{MN}=qE(-0{,}025)=10\times10^{-6}\cdot5000\cdot(-0{,}025)=-1{,}25\times10^{-3}\,\mathrm J$.
#### Bài 63
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Sai.** Từ hình, hai độ dời M→Q và Q→O có hình chiếu theo $\vec E$ trái dấu và bằng độ lớn, nên $A_{MQ}=-A_{QO}$.

    b) **Đúng.** M và P có cùng hoành độ theo phương điện trường nên $A_{MP}=0$.

    c) **Sai.** $U=E\,d$; trên hình $d_{QO}<0$ còn $d_{PH}>0$, nên $U_{QO}<U_{PH}$.

    d) **Đúng.** O và P nằm trên cùng mặt đẳng thế, nên $V_O=V_P$.
#### Bài 64
...
a) Cường độ điện trường E có độ lớn $3000\,\mathrm{V/m}$.

b) Hiệu điện thế UBC = $360\,\mathrm V$.

c) Công của lực điện trường khi electron dịch chuyển từ B đến C là $-5{,}76\cdot10^{-17}\,\mathrm J$.

d) Công của lực điện trường khi electron dịch chuyển từ B đến D là $2{,}88\cdot10^{-17}\,\mathrm J$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Đúng.** $CD=AC/2=0{,}06\,\mathrm m$, nên $E=U_{CD}/CD=180/0{,}06=3000\,\mathrm{V/m}$.

    b) **Sai.** Với $\vec E\parallel CA$, từ B đến C có hình chiếu $-CA=-0{,}12\,\mathrm m$, nên $U_{BC}=-360\,\mathrm V$.

    c) **Sai.** $A_{B\to C}=q_eU_{BC}=(-1{,}6\times10^{-19})(-360)=+5{,}76\times10^{-17}\,\mathrm J$, không phải giá trị âm.

    d) **Đúng.** Từ B đến D, hình chiếu bằng $-CA/2=-0{,}06\,\mathrm m$, nên $A_{B\to D}=(-1{,}6\times10^{-19})\cdot3000\cdot(-0{,}06)=2{,}88\times10^{-17}\,\mathrm J$.
#### Bài 65
...
c) Hiệu điện thế giữa hai bản tụ là $100\,\mathrm V$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    c) **Đúng.** $U=Ed=10^3\cdot0{,}10=100\,\mathrm V$.
...
a) Hiệu điện thế giữa hai tầng mây là $1{,}2\cdot10^{6}\,\mathrm V$.

b) Điện thế của tầng mây trên bằng $0,7\,\mathrm{kV}$.

c) Thế năng điện của tầng trên là $2268\,\mathrm J$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    a) **Đúng.** $U=Ed=1000\cdot1200=1{,}2\times10^6\,\mathrm V$.

    b) **Sai.** Với $V_1=-500\,\mathrm{kV}$ và tầng trên ở điện thế cao hơn $1{,}2\,\mathrm{MV}$, $V_2=700\,\mathrm{kV}$, không phải $0{,}7\,\mathrm{kV}$.

    c) **Sai.** $W=Q_2V_2=3{,}24\cdot700000=2{,}268\times10^6\,\mathrm J$, không phải $2268\,\mathrm J$.

    d) **Đúng.** Điện tích dương đi từ tầng trên xuống tầng dưới cùng chiều điện trường, nên $A=qEd=2\times10^{-12}\cdot1000\cdot1200=2{,}4\times10^{-6}\,\mathrm J=2{,}4\,\mu\mathrm J$.
#### Bài 67
...
b) Hiệu điện thế giữa hai bản (1) và (2) là $60\,\mathrm V$.

c) Điện thế tại bản (3) là $60\,\mathrm V$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    b) **Đúng.** $U_{12}=E_{12}d_{12}=1200\cdot0{,}05=60\,\mathrm V$.

    c) **Đúng.** Chọn $V_1=0$, suy ra $V_2=V_1-U_{12}=-60\,\mathrm V$. Với chiều $\vec E_{23}$ như hình, $V_3=V_2-E_{23}(-0{,}08)=-60+120=60\,\mathrm V$.

    d) **Sai.** Công lực điện khi dịch chuyển từ 2 đến 3 là $A_{23}=q(V_2-V_3)=2\times10^{-6}(-60-60)=-2{,}4\times10^{-4}\,\mathrm J$. Dấu âm là phần quan trọng của kết quả.
#### Bài 68
...
??? success "Đáp án và lời giải"
    **Đáp án:** A. $9{,}6\times10^{-13}\,\mathrm N$.

    **Hướng dẫn giải:**

    Điện trường đều giữa hai cực có độ lớn
    $E=U/d=120\times10^3/0{,}02=6\times10^6\,\mathrm{V/m}$.

    Độ lớn lực điện tác dụng lên electron:
    $F=|q_e|E=1{,}6\times10^{-19}\cdot6\times10^6=9{,}6\times10^{-13}\,\mathrm N$.
...
Một electron đang ở độ cao $1,04\,\mathrm m$ so với mặt đất, tại nơi có điện trường Trái Đất bằng $115\,\mathrm{V/m}$.
...
??? success "Đáp án và lời giải"
    ...
    **Chiến lược.** Từ mốc thế năng tại mặt đất, tính thế năng bằng $W=qV$; với chiều điện trường Trái Đất hướng xuống, điện thế ở độ cao $d$ là $V=Ed$.

    **Dấu.** $q_e<0$ còn $V_M>0$, nên $W_M$ phải âm.

    **Nghiệm.**
    $W_M=q_eEd=(-1{,}6\times10^{-19})\cdot115\cdot1{,}04\approx-1{,}91\times10^{-17}\,\mathrm J=-191\times10^{-19}\,\mathrm J$.
    Vậy chọn **B**.

    **Kiểm tra.** Dấu âm phù hợp với $q_e<0$ tại điểm có điện thế dương so với mốc mặt đất.

    <!-- source-audit: PDF in A và B trùng nhau ở -191e-19 J và đánh dấu B. Kết quả độc lập là -191e-19 J; A được đổi tối thiểu dấu để khôi phục câu một đáp án. -->
#### Bài 76

---
title: "Bài tập — Bài 4 — Tổng hợp điện trường và cân bằng điện tích"
...
Nguyên lí chồng chất điện trường phát biểu
...
Hai điện tích dương bằng nhau đặt tại A và B. Tại trung điểm M của AB, cường độ điện trường tổng hợp bằng
...
??? success "Đáp án và lời giải"
    Chọn **A** vì hai vectơ bằng nhau và ngược hướng.

### Bài 4 — Mức 1 — Nhận biết

Hai điện tích trái dấu có độ lớn bằng nhau đặt tại A và B. Tại trung điểm M, hai vectơ điện trường do chúng gây ra
...
??? success "Đáp án và lời giải"
    Chọn **B**, nên điện trường tổng hợp khác 0.

## Phần B — Đúng/Sai

### Bài 5 — Mức 2 — Thông hiểu

Về điểm có điện trường tổng hợp bằng 0 do hai điện tích điểm:
...
Hai điện trường thành phần $\vec E_1,\vec E_2$ có cùng độ lớn E:
...
<!-- source-id: BT-Chuong-III-p32-q5-86 -->
...
C. $2{,}25\cdot10^{5}\,\mathrm{V/m}$.

D. $4{,}5\cdot10^{5}\,\mathrm{V/m}$.
...
B. $r_1=6\,\mathrm{cm};\ r_2=3\,\mathrm{cm}$.

C. $r_1=4\,\mathrm{cm};\ r_2=8\,\mathrm{cm}$.

D. $r_1=8\,\mathrm{cm};\ r_2=4\,\mathrm{cm}$.
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    $\dfrac{E_2}{E_1}=\dfrac{r_1^2}{r_2^2}=4$

    nên $r_2=\dfrac{r_1}{2}=1\,\mathrm{cm}$. Chọn **B**.
#### Bài 21

<!-- source-id: BT-Chuong-III-p51-q16-155 -->

Cho hai điện tích điểm đặt cố định tại hai điểm A và B, để cường độ điện trường gây bởi hai điện
tích tại trung điểm của đoạn AB bằng 0 thì hai điện tích

A. phải trái dấu, cùng độ lớn.

B. phải cùng dấu, cùng độ lớn.

C. phải trái dấu, khác độ lớn.

D. phải cùng dấu, khác độ lớn.
...
<!-- source-id: BT-Chuong-III-p52-q18-157 -->

Hai điện tích điểm $q_1=-9\,\mu\mathrm C$, $q_2=4\,\mu\mathrm C$ đặt lần lượt tại A, B. Có thể tìm thấy vị trí của điểm M mà
tại đó điện trường tổng hợp bằng không trên
...
??? success "Đáp án và lời giải"
    ...
    **Hướng dẫn giải:**
    ...
    Vì $|q_1|=9\,\mu\mathrm C>|q_2|=4\,\mu\mathrm C$, điểm triệt tiêu phải nằm về phía điện tích có độ lớn nhỏ hơn, tức ngoài đoạn AB về phía B. Chọn **C**.
### Vận dụng — Đúng/Sai

#### Bài 23

<!-- source-id: BT-Chuong-III-p43-q5-126 -->

Tại hai điểm A và B cách nhau $10\,\mathrm{cm}$ trong không khí đặt hai điện tích $q_1=q_2=16\cdot10^{-8}\,\mathrm C$. Điểm M nằm trên đoạn AB sao cho $MA=MB=5\,\mathrm{cm}$.

a) Cường độ điện trường tại M do $q_1$ gây ra có giá trị bằng cường độ điện trường do $q_2$ gây ra tại M.

b) Vectơ cường độ điện trường do $q_1$ gây ra tại M hướng về $q_1$.

c) Vectơ cường độ điện trường do $q_2$ gây ra tại M hướng về $q_1$.
...
b) Độ lớn cường độ điện trường do $q_2$ gây ra tại M là $10\,000\,\mathrm{V/m}$.
...
<!-- source-id: BT-Chuong-III-p54-q3-160 -->

Tại hai điểm A và B cách nhau $5\,\mathrm{cm}$ trong chân không có hai điện tích $q_1=+16\cdot10^{-8}\,\mathrm C$ và $q_2=-9\cdot10^{-8}\,\mathrm C$. Điểm C cách A $4\,\mathrm{cm}$ và cách B $3\,\mathrm{cm}$.

a) Độ lớn cường độ điện trường do $q_1$ gây ra tại C là $900000\,\mathrm{V/m}$.

b) Độ lớn cường độ điện trường do $q_2$ gây ra tại C là $18\cdot10^5\,\mathrm{V/m}$.

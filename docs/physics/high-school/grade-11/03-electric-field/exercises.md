...
### Câu 2
Hai quả cầu dẫn giống nhau có $q_1=8\,\mu$C, $q_2=-2\,\mu$C. Cho tiếp xúc rồi tách. Tìm điện tích mỗi quả.

### Câu 3
Hai điện tích điểm $2\,\mu$C và $-5\,\mu$C cách nhau 20 cm trong chân không. Tính lực tương tác và cho biết hút hay đẩy.
...
### Câu 7
Tại một điểm $E=2\times10^4$ N/C. Điện tích $q=-5$ nC đặt tại đó chịu lực độ lớn bao nhiêu và hướng thế nào so với E?
...
### Câu 10
Tại M có hai vectơ điện trường vuông góc, độ lớn $3\times10^4$ và $4\times10^4$ N/C. Tính E tổng.
...
### Câu 13
$V_M=120$ V, $V_N=50$ V. Tính $U_{MN}$ và công lực điện khi chuyển $q=-2\,\mu$C từ M đến N.

### Câu 14
Điện tích điểm $Q=+4\,\mu$C. Chọn V=0 ở vô cực. Tính V tại r=20 cm.
...
### Câu 21
Hai tụ $C_1=3\,\mu$F, $C_2=6\,\mu$F ghép nối tiếp vào 12 V. Tính $C_{eq}$, Q của chuỗi và U trên mỗi tụ.
...
### Câu 24
Electron được tăng tốc từ nghỉ qua hiệu điện thế có độ lớn 200 V. Viết biểu thức tốc độ theo $e,m_e$.
...
### Câu 28
Hai tụ $C_1=2\,\mu$F, $C_2=8\,\mu$F nối tiếp. Tỉ số $U_1/U_2$ bằng bao nhiêu?
...
### Câu 31
Hai điện tích cùng dấu $q_1=Q$, $q_2=9Q$ cách nhau 40 cm. Tìm vị trí điểm E=0.
...
### Câu 37
Hai điện tích $+Q$ và $-9Q$ cách nhau 40 cm. Xác định miền có thể chứa điểm $E=0$, rồi tìm khoảng cách từ điểm đó tới $+Q$.

### Câu 38
Quả cầu nhỏ khối lượng 10 g, điện tích $+2,0\,\mu$C treo bằng dây trong điện trường đều nằm ngang. Dây lệch 30° so với phương thẳng đứng. Lấy $g=10$ m/s². Tính E.
...
### Câu 40
Một hạt tích điện đứng cân bằng tự do trong điện trường đều thẳng đứng hướng lên. Cho $m=2,0\times10^{-6}$ kg, $q=+5,0\times10^{-9}$ C. Tính E, lấy $g=9,8$ m/s².

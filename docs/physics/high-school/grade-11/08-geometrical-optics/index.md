---
title: "Chương 8 — Khúc xạ ánh sáng và quang hình"
description: "Mở rộng Vật lí 11: khúc xạ, phản xạ toàn phần, lăng kính, thấu kính, mắt và dụng cụ quang."
order: 8
...
```mermaid
graph TD
A[Tia sáng] --> B[Khúc xạ]
B --> C[Chiết suất]
C --> D[Bản mặt song song]
C --> E[Phản xạ toàn phần]
B --> F[Lăng kính]
F --> G[Tán sắc]
B --> H[Thấu kính]
H --> I[Dựng ảnh]
H --> J[Công thức thấu kính]
J --> K[Mắt]
J --> L[Kính lúp]
J --> M[Kính hiển vi]
J --> N[Kính thiên văn]

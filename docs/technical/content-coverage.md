...
| Chương | Lý thuyết | Bài tập | Lời giải | Quiz | Trạng thái |
| --- | --- | --- | --- | --- | --- |
| 1. Dao động cơ học | đầy đủ bản hiện tại | có | có | có | `checked` |
| 2. Sóng | lõi + thực hành + Doppler/nhiễu xạ/tán sắc/quang phổ/nhiều bức xạ | có | có | có | `checked` |
| 3. Điện trường | lõi + cân bằng điện tích/con lắc điện | có | có | có | `checked` |
| 4. Dòng điện và mạch điện | lõi + thực hành + nguồn/máy thu/nhánh tụ | có | có | có | `checked` |
| 5. Dòng điện trong các môi trường | phần mở rộng | có | có | có | `checked` |
| 6. Từ trường và cảm ứng từ | phần mở rộng | có | có | có | `checked` |
| 7. Cảm ứng điện từ | phần mở rộng | có | có | có | `checked` |
| 8. Khúc xạ ánh sáng và quang hình | phần mở rộng | có | có | có | `checked` |

`checked` ở đây nghĩa là đã qua kiểm tra cấu trúc, link, LaTeX và rà logic nội bộ của bản biên soạn. Khi có phản hồi học thuật hoặc thêm corpus mới, mục có thể quay lại `drafted` để sửa.
...
Trước deploy, GitHub Actions chạy bản đầy đủ gồm build MkDocs và kiểm tra HTML render để phát hiện LaTeX lọt ra dạng chữ thô.
